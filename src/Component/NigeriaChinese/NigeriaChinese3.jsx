...
const NigeriaChinese3 = () => {
  return (
    <div className='the-list'>
        <h2>Nigeria & Chinese Menu (III)</h2>
        <div className='the-list-item'>
            <ul className='the-list-food'>
                ...
                <li>Steamed rice</li>
                <li>AStir Fried rice</li>
                <li>Singaporean Noodles</li>
                <li>Shredded beef with green pepper in oyster sauce</li>
                <li>Pan Fried Fish in soy sauce and spring onions</li>
                <li>Prawns in Sweet Chilli Sauce</li>
...
export default NigeriaChinese3